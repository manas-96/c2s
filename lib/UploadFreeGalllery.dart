...
import 'package:call2sex/ZoomImage.dart';
...
class UploadFreeGallery extends StatefulWidget {
  @override
  _UploadFreeGalleryState createState() => _UploadFreeGalleryState();
}

class _UploadFreeGalleryState extends State<UploadFreeGallery> {
  String url="https://www.call2sex.com/api/WorkerApi/UploadFreeGallery";
  File _image;
  var path;
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start,
                ...
                children: [
                  ...
                  Container(width: MediaQuery.of(context).size.width*0.6,
                    child: Text("\nThis gallery will be visible for all users. Think twice before uploading any pics.",
